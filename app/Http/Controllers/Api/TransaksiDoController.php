...
class TransaksiDoController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $transaksi = TransaksiDo::create([
            ...
            'sisa_hutang_penjual' => max(0, $penjual->hutang - $pembayaran_hutang),
            'cara_bayar' => $request->cara_bayar,
            'sisa_bayar' => $sisa_bayar,
        ]);

        // Triger pembaruan saldo dan hutang melalui trait
        $transaksi->handlePembayaran();
